...
const ADVANTAGES = [
  { icon: '✅', title: 'Перевірена техніка', text: 'Перед продажем кожен ноутбук проходить ретельне тестування, очищення від пилу та заміну термоінтерфейсу для стабільної і надійної роботи.' },
  { icon: '🛡️', title: 'Гарантія', text: 'На кожен ноутбук надається гарантія. Якщо протягом гарантійного терміну виникнуть несправності, ми допоможемо з їх усуненням або запропонуємо відповідне рішення.' },
  { icon: '🚚', title: 'Швидка доставка', text: 'Відправляємо Новою Поштою по всій Україні. Доставка зазвичай 1–2 дні.' },
  { icon: '💳', title: 'Зручна оплата', text: 'Оплата на розрахунковий рахунок або накладеним платежем Новою Поштою.' },
